...
# این توابع از xC4 import شده‌اند، اما اگر مشکل داشتیم اینجا هم تعریف می‌کنیم
...
async def EncRypTMajoRLoGin(open_id, access_token):
    ...
    # اضافه کردن memory_available
    from Pb2.MajoRLoGinrEq_pb2 import GameSecurity
    memory_available = GameSecurity()
    memory_available.version = 55
    memory_available.hidden_value = 81
    major_login.memory_available.CopyFrom(memory_available)
